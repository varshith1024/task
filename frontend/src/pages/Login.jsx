...
export default function Login() {
  ...
  return (
    ...
    >
      {/* Background Glow Top */}
      <div className="absolute top-[-150px] left-[10%] w-[550px] h-[550px] bg-[#c8f55a]/10 rounded-full blur-[180px] animate-pulse"></div>

      {/* Background Glow Bottom */}
      <div
        className="absolute bottom-[-180px] right-[10%] w-[500px] h-[500px] bg-[#c8f55a]/5 rounded-full blur-[170px]"
        style={{
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at center, rgba(200,245,90,0.03) 0%, transparent 70%)',
        }}
      />
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 space-y-5 shadow-2xl shadow-black/30">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#c8f55a] focus:ring-2 focus:ring-[#c8f55a]/20"
              required
            />
          </div>
